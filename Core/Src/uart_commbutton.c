...
#include "main.h"
#include "uart_commbutton.h"

extern UART_HandleTypeDef huart2;
extern TIM_HandleTypeDef htim6;
Uart_Ch uart_ch = {.fdata_ready=0,.rx_data_cntr=0, .new_byte_received_flag=0,.tx_data_cntr=0,.new_byte_transmitted_flag=0};
...
uint8_t is_data_valid(uint8_t* data, uint8_t len){
	uint8_t incoming_checksum,i,total=0;
